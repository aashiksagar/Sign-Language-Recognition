...
class Application:
    ...
    def __init__(self):
        ...
        # Custom font styles
        college_font = ("Segoe UI", 24, "bold")
        title_font = ("Segoe UI", 28, "bold")
        label_font = ("Segoe UI", 18, "bold")
        button_font = ("Segoe UI", 14)
        text_font = ("Segoe UI", 16)
        window_label_font = ("Segoe UI", 16, "bold")

        # Set a modern background color
        self.root.configure(bg='#f5f5f5')

        # Load and resize the logo
        logo_img = Image.open("logo.png")  # Use your logo file name
        logo_img = logo_img.resize((60, 60), Image.Resampling.LANCZOS)
        logo_photo = ImageTk.PhotoImage(logo_img)

        # Place the logo to the left of the college name
        self.logo_label = tk.Label(self.root, image=logo_photo, bg='#f5f5f5')
        self.logo_label.image = logo_photo  # Keep a reference!
        self.logo_label.place(x=1300/2 - 400, y=20)  # Moved more to the left

        # College name at the top - centered
        self.college_label = tk.Label(self.root, text="VIGNAN'S INSTITUTE OF INFORMATION TECHNOLOGY", 
                                     font=college_font, bg='#f5f5f5', fg='#1a237e')
        self.college_label.place(x=1300/2 + 100, y=20, anchor="center")  # Moved more to the right

        # Main title - centered
        self.T = tk.Label(self.root, text="Sign Language To Text Conversion", 
                         font=title_font, bg='#f5f5f5', fg='#263238')
        self.T.place(x=1300/2 + 100, y=70, anchor="center")  # Moved more to the right

        # Window labels
        self.webcam_label = tk.Label(self.root, text="Webcam", 
                                   font=window_label_font, bg='#f5f5f5', fg='#263238')
        self.webcam_label.place(x=100, y=100)

        self.hand_label = tk.Label(self.root, text="Hand Detection", 
                                 font=window_label_font, bg='#f5f5f5', fg='#263238')
        self.hand_label.place(x=700, y=100)

        # Video display panel - reduced size and adjusted position
        self.panel = tk.Label(self.root, bg='#263238', bd=1, relief="solid")
        self.panel.place(x=100, y=130, width=450, height=600)

        # Processed image panel - adjusted position
        self.panel2 = tk.Label(self.root, bg='#263238', bd=1, relief="solid")
        self.panel2.place(x=700, y=130, width=400, height=400)

        # Character display
        self.T1 = tk.Label(self.root, text="Character:", font=label_font, 
                          bg='#f5f5f5', fg='#263238')
        self.T1.place(x=600, y=550)
        self.panel3 = tk.Label(self.root, font=text_font, bg='#f5f5f5', fg='#e53935')
        self.panel3.place(x=750, y=550)

        # Sentence display
        self.T3 = tk.Label(self.root, text="Sentence:", font=label_font, 
                          bg='#f5f5f5', fg='#263238')
        self.T3.place(x=600, y=600)
        self.panel5 = tk.Label(self.root, font=text_font, bg='#f5f5f5', fg='#43a047')
        self.panel5.place(x=750, y=600)

        # Suggestions label - moved down to prevent overlap
        self.T4 = tk.Label(self.root, text="Suggestions:", font=label_font, 
                          bg='#f5f5f5', fg='#3949ab')
        self.T4.place(x=600, y=650)
        ...
        self.b1.place(x=750, y=650, width=100, height=35)

        self.b2 = tk.Button(self.root, **button_style)
        self.b2.place(x=900, y=650, width=100, height=35)

        self.b3 = tk.Button(self.root, **button_style)
        self.b3.place(x=1050, y=650, width=100, height=35)

        self.b4 = tk.Button(self.root, **button_style)
        self.b4.place(x=1200, y=650, width=100, height=35)
        ...
        self.speak = tk.Button(self.root, text="Speak", command=self.speak_fun, **action_button_style)
        self.speak.place(x=1150, y=550, width=80, height=35)

        self.clear = tk.Button(self.root, text="Clear", command=self.clear_fun, **action_button_style)
        self.clear.place(x=1050, y=550, width=80, height=35)
